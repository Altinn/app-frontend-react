...
describe('Mobile', () => {
  ...
  it('is possible to submit app instance from mobile', () => {
    ...
    cy.get('#form-content-nav2 > div > nav > button').should('be.visible').and('have.attr', 'aria-expanded', 'false').click();
    cy.get('#form-content-nav2 > div > nav > button').should('have.attr', 'aria-expanded', 'true');
