  ...
  constructor() {
    ...
    this.group = {
      ...
      rows: [0, 1].map((idx) => ({
        ...
        editBtn: `#group-mainGroup-table-body > tr:nth-child(${idx + 1}) > td:first-of-type > button`,
        nestedGroup: {
          rows: [0, 1].map((subIdx) => ({
            ...
            editBtn: `#group-subGroup-${idx}-table-body > tr:nth-child(${subIdx + 1}) > td:first-of-type > button`,
          })),
