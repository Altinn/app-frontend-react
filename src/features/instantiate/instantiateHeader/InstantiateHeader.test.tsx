...
describe('InstantiateHeader', () => {
  it('should not show organisation name when profile has party, and party has organisation with name', async () => {
    ...
    jest.mocked(useCurrentParty).mockReturnValue(org);
  ...
  it('should render links to inbox, schemas and profile when currentParty is defined', async () => {
    jest.mocked(useCurrentParty).mockReturnValue(getPartyMock());
    await render();
  ...
  it('should not render links to inbox, schemas and profile when currentParty is undefined', async () => {
    jest.mocked(useCurrentParty).mockReturnValue(undefined);
    await render();
