...
import type { Expression, ExprValueArgsConfig } from 'src/features/expressions/types';
      ...
      for (const node of allNodes) {
        ...
        for (const reference of Object.values(dmb as Record<string, IDataModelReference>)) {
          ...
          for (const validationDef of validationDefs) {
            const valueArguments: ExprValueArgsConfig<{ field: string }> = { data: { field }, defaultKey: 'field' };
