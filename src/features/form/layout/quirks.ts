...
export const quirks: { [key: string]: QuirkDef } = {
  ...
  'pat/correspondence/form': {
    verifyAndApply(layouts) {
      removeChildThatDoesNotExist(
        layouts,
        'request-personalCases-searchIsChosenCase',
        'request-personalCases-group',
        'Group',
      );
    },
    logMessages: [
      `Removed child 'request-personalCases-searchIsChosenCase' from component 'request-personalCases-group' which does not exist'`,
    ],
  },
};
