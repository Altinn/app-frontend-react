  ...
  it('runSingleFieldValidationSaga, single field validation is triggered', () => {
    ...
    return expectSaga(runSingleFieldValidationSaga, {
      ...
      .provide([
        ...
        [select(selectHiddenFields), mockState.formLayout.uiConfig.hiddenFields],
        [select(selectInstanceState), mockState.instanceData.instance],
        [select(selectLayoutSets), mockState.formLayout.layoutsets],
        [select(selectTextResources), mockState.textResources.resources],
