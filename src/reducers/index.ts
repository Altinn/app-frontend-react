...
import { dataModelSlice } from 'src/features/form/datamodel/datamodelSlice';
...
import { rulesSlice } from 'src/features/form/rules/rulesSlice';
...
const reducers = {
  ...
  [dataModelSlice.name]: dataModelSlice.reducer,
