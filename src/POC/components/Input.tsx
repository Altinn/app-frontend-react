...
// //TODO: generate types for the config from TE
// export type InputProps = CompInputExternal;
...
//   maxLength,
// }: InputProps) => {
//   // const isValid = useIsValid(node); // TODO:
//   const {
...
//     prefixText: textResourceBindings?.prefix,
//     suffixText: textResourceBindings?.suffix,
//   };
