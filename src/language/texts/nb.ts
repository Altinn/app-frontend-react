...
export function nb() {
  return {
    ...
    'service_task.title': 'Noe gikk galt under behandlingen',
    'service_task.body':
      'En feil oppstod under automatisk behandling av skjemaet. Dette kan skyldes problemer med generering av PDF-sammendrag eller andre tekniske feil.',
