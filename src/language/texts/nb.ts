...
export function nb(): FixedLanguageList {
  return {
    ...
    config_error: {
      ...
      deletion_strategy_no_save_to_list: 'Feltene deletionStrategy og checked kan kun brukes sammen med group.',
      save_to_list_no_deletion_strategy: 'Når du har satt group må du også sette deletionStrategy.',
      soft_delete_no_is_deleted: 'Når du har satt deletionStrategy til soft må du også sette "checked".',
      hard_delete_with_is_deleted: 'Når du har satt deletionStrategy til hard kan du ikke sette "checked".',
    },
    version_error: {
