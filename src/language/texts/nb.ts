...
export function nb(): FixedLanguageList {
  return {
    ...
    config_error: {
      ...
      deletion_strategy_no_group: 'Feltene deletionStrategy og checked kan kun brukes sammen med group.',
      group_no_deletion_strategy: 'Når du har satt group må du også sette deletionStrategy.',
      soft_delete_no_checked: 'Når du har satt deletionStrategy til soft må du også sette "checked".',
      hard_delete_with_checked: 'Når du har satt deletionStrategy til hard kan du ikke sette "checked".',
    },
    version_error: {
