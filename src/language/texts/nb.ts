...
export function nb() {
  return {
    ...
    'wallet.confirm_claims_description': 'Følgende informasjon vil bli forespurt:',
    'wallet.claim_mandatory': 'påkrevd',
    'wallet.confirm_proceed': 'Fortsett',
    'wallet.cancel_request': 'Avbryt forespørsel',
    'wallet.back_to_list': 'Tilbake til listen',
    'wallet.starting_verification': 'Starter verifisering...',
    'wallet.start_failed': 'Kunne ikke starte lommebokverifisering. Prøv igjen.',
    'wallet.verification_title': 'Fullfør verifisering i lommeboken din',
    'wallet.verification_description':
      'Skann QR-koden med lommebok-appen din, eller klikk på lenken under for å åpne din digitale lommebok og godkjenn forespørselen om legitimasjon:',
    'wallet.open_wallet': 'Åpne lommebok-appen på denne enheten',
    'wallet.waiting_for_verification': 'Venter på at du fullfører verifisering...',
    'wallet.verification_failed': 'Verifiseringen feilet eller ble avbrutt. Prøv igjen.',
    'wallet.success_title': 'Legitimasjon hentet',
    ...
    'wallet.help_step_1': 'Be om dokument fra lommebok for å motta data',
    'wallet.help_step_2': 'Last ned XSD-filen fra dialogen når data er mottatt',
    'wallet.help_step_3': 'Last opp dette som en ny datamodell i Altinn Studio',
    'wallet.help_step_4': 'Sett <code>saveToDataType</code>-egenskapen til datatype-ID-en',
