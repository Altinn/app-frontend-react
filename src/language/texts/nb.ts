...
export function nb() {
  return {
    ...
    'wallet.request_title': 'Be om norsk nasjonal identifikasjon fra lommebok',
    'wallet.request_description':
      'Klikk på knappen under for å be om din norske nasjonale identifikasjon fra din digitale lommebok.',
    ...
    'wallet.open_wallet': 'Åpne lommebok-app',
