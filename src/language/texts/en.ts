export function en() {
  return {
    ...
    'service_task.title': 'Something went wrong during processing',
    'service_task.body':
      'An error occurred during automatic processing of the form. This may be due to issues with PDF summary generation or other technical errors.',
