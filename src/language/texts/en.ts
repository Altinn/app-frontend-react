export function en() {
  return {
    ...
    'wallet.request_title': 'Request Norwegian National ID from Wallet',
    'wallet.request_description':
      'Click the button below to request your Norwegian national identification from your digital wallet.',
    'wallet.request_button': 'Request Credential',
    'wallet.starting_verification': 'Starting verification...',
    'wallet.start_failed': 'Failed to start wallet verification. Please try again.',
    'wallet.verification_title': 'Complete Verification in Your Wallet',
    'wallet.verification_description':
      'Scan the QR code with your wallet app, or click the link below to open your digital wallet and authorize the credential request:',
    'wallet.open_wallet': 'Open Wallet App',
    'wallet.waiting_for_verification': 'Waiting for you to complete verification...',
    'wallet.verification_failed': 'Verification failed or was cancelled. Please try again.',
    'wallet.success_title': 'Credential Retrieved',
    'wallet.try_again': 'Try Again',
    'wallet.request_new': 'Request New Credential',
    'wallet.claim_national_id_number': 'National ID Number',
    'wallet.claim_national_id_type': 'ID Type',
    'wallet.claim_name': 'Name',
    'wallet.claim_birth_date': 'Birth Date',
    'wallet.claim_document_number': 'Document Number',
    'wallet.claim_issuing_country': 'Issuing Country',
