...
export function nn() {
  return {
    ...
    'wallet.request_title': 'Be om norsk nasjonal identifikasjon frå lommebok',
    'wallet.request_description':
      'Klikk på knappen under for å be om din norske nasjonale identifikasjon frå din digitale lommebok.',
    ...
    'wallet.open_wallet': 'Opne lommebok-app',
