...
const FormDataActions = {
  ...
  fetchShadowFieldsFulfilled: createAction<IFetchFormDataFulfilled>(
    `${moduleName}/fetchShadowFieldsFulfilled`
  ),
  ...
  updateShadowFieldsFulfilled: createAction<IUpdateFormDataFulfilled>(
    `${moduleName}/updateShadowFieldsFulfilled`
  ),
