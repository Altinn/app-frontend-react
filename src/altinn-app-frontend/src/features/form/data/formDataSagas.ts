...
import { watchSaveFormDataSaga, watchSubmitFormSaga, watchAutoSaveSaga, watchSaveShadowFieldsSaga } from './submit/submitFormDataSagas';
...
export default function* formDataSagas(): SagaIterator {
  ...
  yield fork(watchSaveShadowFieldsSaga);
}
