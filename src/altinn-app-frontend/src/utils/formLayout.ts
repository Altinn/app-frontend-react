...
export function isGroupComponent(component: any): component is ILayoutGroup {
  return (
    component && component.type && component.type.toLowerCase() === "group"
  );
}
...
export function isFileUploadComponent(
  ...
  return (
    component && component.type && component.type.toLowerCase() === "fileupload"
  );
}
...
export function isFileUploadWithTagComponent(
  ...
  return (
    component &&
    component.type &&
    component.type.toLowerCase() === "fileuploadwithtag"
  );
}
...
export function isDatePickerComponent(
  ...
  return (
    component && component.type && component.type.toLowerCase() === "datepicker"
  );
}
