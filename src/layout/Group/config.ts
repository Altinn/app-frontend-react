...
export const Config = new CG.component({
  ...
  .addTextResource(
    new CG.trb({
      ...
      title: 'Title',
      description:
        'The title of the group (shown above the group for non-repeating ' +
        'groups, or above each instance in a Summary for repeating groups)',
    }),
  )
  .addTextResource(
    new CG.trb({
  ...
  .addTextResource(
    new CG.trb({
      name: 'add_label',
      title: 'Add label (for non-repeating groups displayed as Panel and referencing a repeating group)',
  ...
  .addTextResource(
    new CG.trb({
      name: 'body',
      title: 'Body (for non-repeating groups displayed as Panel)',
    ...
    new CG.obj(
      new CG.prop(
        ...
        new CG.str()
          .setTitle('Group')
          .setDescription(
            'Dot notation location for a repeating group structure (array of objects), where the data ' +
  ...
  .addProperty(
    new CG.prop(
      ...
      new CG.obj(
        new CG.prop(
          'mode',
          new CG.enum('hideTable', 'showTable', 'showAll', 'onlyTable', 'likert')
            .optional('showTable')
            .setTitle('Mode')
