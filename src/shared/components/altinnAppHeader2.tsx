...
import { returnUrlToAllSchemas, returnUrlToMessagebox, returnUrlToProfile } from 'src/utils/appUrlHelper';
...
export const AltinnAppHeader2 = ({ type, profile, language }: IHeaderProps) => {
