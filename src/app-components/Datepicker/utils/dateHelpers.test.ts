...
describe('dateHelpers', () => {
  ...
  describe('getDateConstraint', () => {
    const tests: { props: Parameters<typeof getDateConstraint>; expected: string }[] = [
      ...
      { props: [DateFlags.Yesterday, 'min'], expected: '2023-06-06T00:00:00Z' },
      { props: [DateFlags.Yesterday, 'max'], expected: '2023-06-06T23:59:59Z' },
      { props: [DateFlags.Tomorrow, 'min'], expected: '2023-08-06T00:00:00Z' },
      { props: [DateFlags.Tomorrow, 'max'], expected: '2023-08-06T23:59:59Z' },
      { props: [DateFlags.OneYearAgo, 'min'], expected: '2022-08-06T00:00:00Z' },
      { props: [DateFlags.OneYearAgo, 'max'], expected: '2022-08-06T23:59:59Z' },
      { props: [DateFlags.OneYearFromNow, 'min'], expected: '2024-08-06T00:00:00Z' },
      { props: [DateFlags.OneYearFromNow, 'max'], expected: '2024-08-06T23:59:59Z' },
